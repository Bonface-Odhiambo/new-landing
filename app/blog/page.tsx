...
export const metadata = getSEOTags({
  title: `${config.appName} Blog | Editing for Academic Writing`,
  description: "Check how Eclipse can help you as an Employer",
    ...
    <>
      <section className="mx-auto mt-12 mb-24 max-w-xl text-center md:mb-32">
        ...
        <p className="text-lg leading-relaxed opacity-80 text-slate-600">
          Check out how Eclipse has helped Employers and Writers. 
        </p>
      </section>
