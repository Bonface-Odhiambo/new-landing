...
const features = [
  {
    id: 1,
    title: "Focused Engagement with Writers",
    description:
      "Say goodbye to hours of Contemplating. Hire our writers and escape the rabbit hole of bad paper quality.",
    additionalInfo: [
      "Save yourself from fraud by using our escrow",
      "Get committed, disciplined writers",
  ...
  {
    id: 2,
    title: "One-Click Employer Dashboard",
    description:
      "Need a paper done neatly, quickly? Our writers and editors work collegially to get it rendered - saving you time and boosting your productivity.",
    additionalInfo: [
      "Instant order creation",
      "Full quality report from the Eclipse Editor",
      "Perfectly aligned with your paper requirements",
    ],
    icons: [
      <svg
        key="click"
  ...
  {
    id: 3,
    title: "The Epitome of Great Editing",
    description:
      "Eclipse Editors check each paper. No paper escapes the quality check. It's that simple!",
    additionalInfo: [
      "User-friendly interaction with editors on Eclipse Chat",
      "All employers get their papers from the editors",
      "Editors provide free AI and plagiarism report for each paper",
    ],
    icons: [
      <svg
        key="edit"
    ...
    >
      ...
      <TestimonialSingle
        testimonial={{
          name: "Everline Swaya",
          content:
            "Eclipse has been the best platform for me to get assigned jobs in season and out of season. It has insulated me from fradulent employers in Kenya.",
          schoolName: "Kwale",
          image: "https://api.dicebear.com/6.x/avataaars/svg?seed=Amanda",
        }}
      />
    </section>
  );
