          ...
          <div className="rounded-2xl bg-white shadow-lg ring-2 ring-inset ring-slate-200">
            <div className="p-8 sm:p-12">
              ...
              <h3 className="font-display mt-4 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">
                Fraud and subpar paper quality prevailed
              </h3>
              <ul className="mt-6 space-y-3 text-base text-slate-600 sm:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Employers could hire writers on social media and get away with not paying them
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Writers were not confident with any platform because of sheer porosity to invasion by greedy actors
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Genuine employers were not insulated from mediocre writers
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Editors did not give employers quality guarantees letting writers bear the brunt of bad quality
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="p-8 sm:p-12">
              ...
              <ul className="mt-6 space-y-3 text-base text-white sm:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Exceptional writers to meet employer&apos;s needs. Eclipse Writers tests all writers before onboarding
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Employers receive their final papers from editors rendering tremendous quality
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Employers get free AI and plagiarism reports
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Both employer and writer subscription fees are lowest on Eclipse
                </li>
              </ul>
            </div>
          </div>
